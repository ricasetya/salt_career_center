...
class _LoginsPageState extends State<LoginsPage> {
  ...
  void initState() {
    super.initState();
    _loginsBloc = LoginsBloc(LoginsRepositoryImpl());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: BlocListener<LoginsBloc, LoginsState>(
          listener: (context, loginsState) {
            if (loginsState is LoginsIsFailed) {
              Commons().showSnackbarError(context, loginsState.message!);
            } else if (loginsState is LoginsSuccess) {
              print('Oke');
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            BlocProvider.of<LoginsBloc>(context).add(
                              UserLoginsEvent(
