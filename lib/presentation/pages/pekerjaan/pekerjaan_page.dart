...
class DaftarPekerjaanPage extends StatefulWidget {
  const DaftarPekerjaanPage({super.key});

  @override
  State<DaftarPekerjaanPage> createState() => _DaftarPekerjaanPage();
}

class _DaftarPekerjaanPage extends State<DaftarPekerjaanPage> {
                        ...
                        GestureDetector(
                          ...
                          child: const Card(
                            ...
                            child: ListTile(
                              ...
                              title: Text("Internal Communications Intern"),
                              subtitle: Text("Pintu"),
                            ),
                          ),
                        ),
                          ...
                          child: const Card(
                            ...
                            child: ListTile(
                              leading: CircleAvatar(
                                backgroundColor: Color(0xffE6E6E6),
                                backgroundImage:
                                    AssetImage("assets/images/image888.png"),
                              ),
                              title: Text("Accounting Officer"),
                              subtitle: Text("Accenture Southeast Asia"),
                            ),
                          ...
                          child: const Card(
                            ...
                            child: ListTile(
                              leading: CircleAvatar(
                                backgroundColor: Color(0xffE6E6E6),
                                backgroundImage:
                                    AssetImage("assets/images/image892.png"),
                              ),
                              title: Text("Administration Warranty Staff"),
                              subtitle: Text("KOMPAS GRAMEDIA"),
                            ),
                          ...
                          child: const Card(
                            ...
                            child: ListTile(
                              leading: CircleAvatar(
                                backgroundColor: Color(0xffE6E6E6),
                                backgroundImage:
                                    AssetImage("assets/images/image891.png"),
                              ),
                              title: Text(
                                  "Web Designer/ Web Developer/ Programmer"),
                              subtitle: Text("PT Mencari Cinta Sejati"),
                          ...
                          child: const Card(
                            ...
                            child: ListTile(
                              leading: CircleAvatar(
                                backgroundColor: Color(0xffE6E6E6),
                                backgroundImage:
                                    AssetImage("assets/images/image890.png"),
                              ),
                              title: Text("Internal Communications Intern"),
                              subtitle: Text("Pintu"),
                            ),
                          ...
                          child: const Card(
                            ...
                            child: ListTile(
                              leading: CircleAvatar(
                                backgroundColor: Color(0xffE6E6E6),
                                backgroundImage:
                                    AssetImage("assets/images/image889.png"),
                              ),
                              title: Text(
                                  "Web Designer/ Web Developer/ Programmer"),
                              subtitle: Text("ConnectedLife Health"),
...
List<DaftarPekerjaan> daftar = [
  DaftarPekerjaan(
      posisi: "Accounting Officer",
      perusahaan: "Accenture Southeast Asia",
      image: "assets/images/image4.png",
      addres: "Kebon Jeruk, Jakarta Barat",
      date: "24 Jan 2023"),
];
